import mermaid from "@/assets/mermaid1.png";
  ...
  return (
    <>
      <footer className="bg-ink text-navy-foreground py-10 px-6 md:px-12 relative overflow-hidden">
        <div className="mx-auto max-w-2xl grid md:grid-cols-2 gap-12 relative">
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-navy-foreground/70">
              <li><a href="mailto:question@askania.xyz" className="transition-colors hover:text-primary">Email</a></li>
              <li><a href="https://www.instagram.com/ask.ania.xyz" target="_blank" rel="noreferrer" className="transition-colors hover:text-primary">Instagram</a></li>
              <li>FAQ</li>
            </ul>
          </div>
